...
public class MapsActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    private String selectMarkerSnippet;
...
//        String apiKey = getString(R.string.google_maps_key);
        Places.initialize(getApplicationContext(), "AIzaSyDdNKf8bG6mB2DzZ_Pk2tWqHXpBW_rF4aM");
...
//    }
    ...
    /**
     * Prompts the user for permission to use the device location. 获得位置权限
     */
...
//        mMap.moveCamera(CameraUpdateFactory.newLatLng(sydney));
    ...
    private AdapterView.OnItemClickListener listClickedHandler = new AdapterView.OnItemClickListener() {
        public void onItemClick(AdapterView parent, View v, int position, long id) {
            ...
            selectPlaceName = mLikelyPlaceNames[position];
            selectLatLng = mLikelyPlaceLatLngs[position];
            selectMarkerSnippet = mLikelyPlaceAddresses[position];

            Log.e("markerSnippet", selectMarkerSnippet);
            if (mLikelyPlaceAttributions[position] != null) {
                selectMarkerSnippet = selectMarkerSnippet + "\n" + mLikelyPlaceAttributions[position];
            }
            ...
            mMap.addMarker(new MarkerOptions()
                    .title(selectPlaceName)
                    .position(selectLatLng)
                    .snippet(selectMarkerSnippet));
    ...
    public void selectPlace(View view) {
        Log.e("selectPlaceName", selectPlaceName);
        Log.e("selectLatLng", String.valueOf(selectLatLng));
        Log.e("selectMarkerSnippet", selectMarkerSnippet);

        // 发布事件
        EventBus.getDefault().post(new MessageEvent(selectPlaceName));
        finish();//销毁当前Activity
    }
}